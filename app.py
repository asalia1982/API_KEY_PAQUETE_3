...
@st.cache_resource
def cargar_modelo():
    pkl = 'kmeans_riesgo_actuarial.pkl' if os.path.exists('kmeans_riesgo_actuarial.pkl') 
    meta = 'model_metadata.json' if os.path.exists('model_metadata.json') 
...
@st.cache_data
def cargar_base():
    csv = 'insurance.csv' if os.path.exists('insurance.csv') 
